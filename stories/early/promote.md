...
また、初期開発者が後乗りの企業の行った機能追加を安価に手に入れることができ、
ハッピーという話もかぶせてある。
...
* 業種: 宿泊業
* 年商: 500億円
* 部屋数: 1500部屋(東京)、2000部屋(大阪)
* 従業員数: 1000人
* 月間宿泊人数: 10万人
* 今回の案件: Web予約システム
* サービスの形態: 見た目の変更、機能追加、ASPでの利用
...
それに機能を追加した場合、その機能を花男は安価で使うことができる
という点だった。
「トリヒコ」が言うには、オープンソースの手法を使うことで、
業界内でシェア争いをするよりも、
むしろ宿泊業という業界全体の魅力を増すことで全体のパイを増やすことができる、
とのことだった。
...
* 「予約の花」をホテルラグジュアリに導入したときに
	+ もとのシステムのバグの場合にだけ転送することで負荷を減らした
	+ その後の機能拡張の段階でスケールするように最適化した
	+ 普段コードをメンテナンスしていく段階でスケールすることを意識したい
